...
function form_verify() {
    ...
    if (pwdValue ==="") {
        ...
        let message = "il doit contenir au moins 8 caractere pas de Maj ou Minsc ";
        setError(password,message)
    }else{
        setSuccess(password);
    }
    ...
    if (pwd2Value ==="") {
        ...
        window.location="file:///C:/Users/ASUS/OneDrive/Bureau/3IIR/js%20projet/js%20projet%20cmp/indexe.html";
